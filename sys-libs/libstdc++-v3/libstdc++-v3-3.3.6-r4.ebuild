...
do_filter_flags() {
	...
	# GCC-15 seemingly requires -std=gnu99 and O1, according to:
	# https://aur.archlinux.org/cgit/aur.git/commit/PKGBUILD?h=libstdc%2b%2b5&id=a1e27dfeba4dd2865ef35c53769d3498866770cf
	# Added -w to stop the many random harmless warnings (might want to remove)
	newflags+=" -fno-strict-aliasing -std=gnu99 -w"
